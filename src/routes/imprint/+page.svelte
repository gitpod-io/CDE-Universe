<div class="mx-auto mb-medium max-w-xl">
  ...
  <div>Gitpod GmbH</div>
  <div>Managing Directors: Sven Efftinge, Moritz Eysholdt</div>
  ...
  <br />
  <div>Email: <a href="mailto:contact@gitpod.io">contact@gitpod.io</a></div>
  <h2 class="text-bold pt-small text-left text-h4">Disclaimer</h2>

  <h4 class="pt-4">Liability for content</h4>
  <p>
  ...
  <h4 class="pt-4">Liability for links</h4>
  <p>
